 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    ")\n",
    "\n",
    "# Save the model to file under the folder name model\n",
  ...
  {
   "cell_type": "markdown",
   "id": "d2dd5d5a-1373-44af-8bd3-d071d6498f08",
   "metadata": {},
   "source": [
    "## Convert the Model to OpenVINO\n",
    "\n",
    "Convert the model you've created into an OpenVINO format so that we can host this model in OpenVINO model server"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "27c38888-dd8c-41dc-911b-a99c93b54d5b",
   "metadata": {},
   "outputs": [],
   "source": [
